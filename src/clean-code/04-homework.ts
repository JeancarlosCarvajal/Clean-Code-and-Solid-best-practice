(() => {
  ...
  type FruitColor = 'red'|'yellow'|'purple'; // darle valores exclusivos a una variable
  function getFruitsByColor(color: string): string[] {
    ...
    if (color === 'purple') return ['moras', 'uvas'];
     // throw nunca puede ser un return segun typeScript.. the technical term for what never...
